...
Mobile.tap(findTestObject('Object Repository/XCUIElementTypeImage - ic__general_tab_inactive__inbox'), 0)

Mobile.tap(findTestObject('Object Repository/XCUIElementTypeButton - Back (9)'), 0)
