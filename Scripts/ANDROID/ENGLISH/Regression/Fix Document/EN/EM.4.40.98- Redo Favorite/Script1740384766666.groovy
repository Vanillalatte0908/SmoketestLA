...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - Go to Payment'), 0)

Mobile.sendKeys(findTestObject('Object Repository/android.widget.EditText - 0'), '1')
